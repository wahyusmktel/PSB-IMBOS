                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <form action="{{ route('operator.pendaftar.index') }}" method="GET" class="form-inline w-100">
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <!-- Filter Gelombang -->
                                    <div class="form-group mr-3 mb-2">
                                        <label for="gelombang" class="mr-2">Gelombang</label>
                                        <select name="filter_gelombang" id="gelombang" class="form-control">
                                            <option value="">Pilih Gelombang</option>
                                            <option value="1"
                                                {{ request('filter_gelombang') == '1' ? 'selected' : '' }}>Gelombang 1
                                            </option>
                                            <option value="2"
                                                {{ request('filter_gelombang') == '2' ? 'selected' : '' }}>Gelombang 2
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <form action="{{ route('operator.hasil-seleksi.store') }}" method="POST"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="hasil_kelulusan" id="hasil_kelulusan"
                                    ...
                                    @foreach ($akunPendaftars as $akunPendaftar)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $status_kelulusan =
                                                        $akunPendaftar->hasilSeleksi->hasil_kelulusan ?? null;
                                                @endphp
                                            ...
                                            <td>{{ ($akunPendaftar->gelombang ?? 1) == 2 ? 'Gelombang 2' : 'Gelombang 1' }}
                                            </td>
