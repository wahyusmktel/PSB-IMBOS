...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <h3 class="text-center">Login Pendaftar</h3>
            <p class="text-center">Silahkan Masukan Data Dengan Benar</p>
            <div class="login-form mt-2">
                <form method="POST" action="{{ route('pendaftar.login') }}">
                    @csrf
                    <div class="form-group form-floating-label">
                        <input id="username" name="username" type="text" class="form-control input-border-bottom" required>
                        <label for="username" class="placeholder">Masukan Nomor Pendaftaran</label>
                    </div>
                    <div class="form-group form-floating-label">
                        <input id="password" name="password" type="number" class="form-control input-border-bottom" required>
                        <label for="password" class="placeholder">Masukan NISN</label>
                    ...
                    <div class="form-action mb-3">
                        <button id="btnLogin" type="submit" class="btn btn-primary btn-rounded btn-login w-100"><i class="fas fa-sign-in-alt"></i> Masuk</button>
                    </div>
                </form>
            </div>
            ...
            <p class="mt-2 text-center">
                Belum punya akun? <a href="/pendaftar/register">Daftar Disini</a>
            </p>
        </div>
    </div>
