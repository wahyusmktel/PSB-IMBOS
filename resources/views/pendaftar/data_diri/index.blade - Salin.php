                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-contact-tab-nobd" data-toggle="pill" href="#kuesioner"
                                    role="tab" aria-controls="kuesioner" aria-selected="false"><i
                                        class="fas fa-question-circle"></i> Lain - Lain</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
                                    ...
                                    <div class="col-md-6">
                                        <form method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="alamat_tempat_tinggal" class="form-control" rows="4">{{ $alamat->alamat_tempat_tinggal ?? old('alamat_tempat_tinggal') }}</textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="rt">RT</label>
                                                <input type="number" name="rt" class="form-control"
                                                    value="{{ $alamat->rt ?? old('rt') }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="rw">RW</label>
                                                <input type="number" name="rw" class="form-control"
                                                    value="{{ $alamat->rw ?? old('rw') }}">
                                            </div>
                                        ...
                                        <form method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="agama_ayah" class="form-control">
                                                    ...
                                                    <option value="Islam"
                                                        {{ isset($biodata_orang_tua->agama_ayah) && $biodata_orang_tua->agama_ayah == 'Islam' ? 'selected' : '' }}>
                                                        Islam</option>
                                                    <option value="Kristen"
                                                        {{ isset($biodata_orang_tua->agama_ayah) && $biodata_orang_tua->agama_ayah == 'Kristen' ? 'selected' : '' }}>
                                                        Kristen</option>
                                                    <option value="Katolik"
                                                        {{ isset($biodata_orang_tua->agama_ayah) && $biodata_orang_tua->agama_ayah == 'Katolik' ? 'selected' : '' }}>
                                                        Katolik</option>
                                                    <option value="Hindu"
                                                        {{ isset($biodata_orang_tua->agama_ayah) && $biodata_orang_tua->agama_ayah == 'Hindu' ? 'selected' : '' }}>
                                                        Hindu</option>
                                                    <option value="Buddha"
                                                        {{ isset($biodata_orang_tua->agama_ayah) && $biodata_orang_tua->agama_ayah == 'Buddha' ? 'selected' : '' }}>
                                                        Buddha</option>
                                                    <option value="Konghucu"
                                                        {{ isset($biodata_orang_tua->agama_ayah) && $biodata_orang_tua->agama_ayah == 'Konghucu' ? 'selected' : '' }}>
                                                        Konghucu</option>
                                                </select>
                                                @error('agama_ayah')
                                                    <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tgl_lahir_ayah" class="form-control"
                                                    value="{{ $biodata_orang_tua->tgl_lahir_ayah ?? old('tgl_lahir_ayah') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="pendidikan_terakhir_ayah" class="form-control">
                                                    ...
                                                    <option value="SD"
                                                        {{ isset($biodata_orang_tua->pendidikan_terakhir_ayah) && $biodata_orang_tua->pendidikan_terakhir_ayah == 'SD' ? 'selected' : '' }}>
                                                        SD</option>
                                                    <option value="SMP"
                                                        {{ isset($biodata_orang_tua->pendidikan_terakhir_ayah) && $biodata_orang_tua->pendidikan_terakhir_ayah == 'SMP' ? 'selected' : '' }}>
                                                        SMP</option>
                                                    <option value="SMA"
                                                        {{ isset($biodata_orang_tua->pendidikan_terakhir_ayah) && $biodata_orang_tua->pendidikan_terakhir_ayah == 'SMA' ? 'selected' : '' }}>
                                                        SMA</option>
                                                    <option value="Diploma"
                                                        {{ isset($biodata_orang_tua->pendidikan_terakhir_ayah) && $biodata_orang_tua->pendidikan_terakhir_ayah == 'Diploma' ? 'selected' : '' }}>
                                                        Diploma</option>
                                                    <option value="Sarjana"
                                                        {{ isset($biodata_orang_tua->pendidikan_terakhir_ayah) && $biodata_orang_tua->pendidikan_terakhir_ayah == 'Sarjana' ? 'selected' : '' }}>
                                                        Sarjana</option>
                                                    <option value="Magister"
                                                        {{ isset($biodata_orang_tua->pendidikan_terakhir_ayah) && $biodata_orang_tua->pendidikan_terakhir_ayah == 'Magister' ? 'selected' : '' }}>
                                                        Magister</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label for="range_gaji_ayah">Range Gaji Ayah</label>
                                                <select name="range_gaji_ayah" class="form-control">
                                                    <option value="">-- Pilih Range Gaji --</option>
                                                    <option value="< 1 Juta"
                                                        {{ isset($biodata_orang_tua->range_gaji_ayah) && $biodata_orang_tua->range_gaji_ayah == '< 1 Juta' ? 'selected' : '' }}>
                                                        < 1 Juta</option>
                                                    <option value="1-3 Juta"
                                                        {{ isset($biodata_orang_tua->range_gaji_ayah) && $biodata_orang_tua->range_gaji_ayah == '1-3 Juta' ? 'selected' : '' }}>
                                                        1-3 Juta</option>
                                                    <option value="3-5 Juta"
                                                        {{ isset($biodata_orang_tua->range_gaji_ayah) && $biodata_orang_tua->range_gaji_ayah == '3-5 Juta' ? 'selected' : '' }}>
                                                        3-5 Juta</option>
                                                    <option value="5-10 Juta"
                                                        {{ isset($biodata_orang_tua->range_gaji_ayah) && $biodata_orang_tua->range_gaji_ayah == '5-10 Juta' ? 'selected' : '' }}>
                                                        5-10 Juta</option>
                                                    <option value="> 10 Juta"
                                                        {{ isset($biodata_orang_tua->range_gaji_ayah) && $biodata_orang_tua->range_gaji_ayah == '> 10 Juta' ? 'selected' : '' }}>
                                                        > 10 Juta</option>
                                                </select>
                                                @error('range_gaji_ayah')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                <input type="email" name="email_ayah" class="form-control"
                                                    value="{{ $biodata_orang_tua->email_ayah ?? old('email_ayah') }}">
                                                @error('email_ayah')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div> --}}
                            ...
                            <div class="tab-pane fade" id="kuesioner" role="tabpanel"
                                ...
                                <form method="POST"
                                    action="{{ $kuesioner ? route('pendaftar.kuesioner.update', $kuesioner->id) : route('pendaftar.kuesioner.store') }}">
                                    @csrf
                                    @if ($kuesioner)
                                        @method('PUT')
                                    @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="masuk_insan_mulia" id="masuk_insan_mulia"
                                            class="form-control select2" style="width: 100%">
                                            <option value="">-- Pilih Alasan --</option>
                                            <option value="Rekomendasi Teman"
                                                {{ $kuesioner && $kuesioner->masuk_insan_mulia == 'Rekomendasi Teman' ? 'selected' : '' }}>
                                                Rekomendasi Teman</option>
                                            <option value="Informasi Sosial Media"
                                                {{ $kuesioner && $kuesioner->masuk_insan_mulia == 'Informasi Sosial Media' ? 'selected' : '' }}>
                                                Informasi Sosial Media</option>
                                            <option value="Lainnya"
                                                {{ $kuesioner && $kuesioner->masuk_insan_mulia == 'Lainnya' ? 'selected' : '' }}>
                                                Lainnya</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="dari_mana" id="dari_mana" class="form-control select2"
                                            ...
                                            <option value="Media Sosial"
                                                {{ $kuesioner && $kuesioner->dari_mana == 'Media Sosial' ? 'selected' : '' }}>
                                                Media Sosial</option>
                                            <option value="Teman"
                                                {{ $kuesioner && $kuesioner->dari_mana == 'Teman' ? 'selected' : '' }}>
                                                Teman</option>
                                            <option value="Pameran Pendidikan"
                                                {{ $kuesioner && $kuesioner->dari_mana == 'Pameran Pendidikan' ? 'selected' : '' }}>
                                                Pameran Pendidikan</option>
                                        </select>
                                    </div>
                                ...
                                <tbody>
                                    @foreach ($berkas as $b)
                                        <tr>
                                            ...
                                            <!-- Upload Berkas -->
                                            <td>
                                                <form method="POST" action="{{ route('pendaftar.berkas.store') }}"
