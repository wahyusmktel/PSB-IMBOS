...
@section('content')
                                ...
                                <form method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        @enderror
                                            ...
                                            <div class="form-group">
                                                <label for="ukuran_baju">Saudara Kandung Di IMBOS ( Jika ada )</label>
                                                <input type="text" class="form-control" name="ukuran_baju"
                                                    placeholder="Masukan nama saudara kandung jika ada..."
    ...
    @enderror
                        ...
                        <!-- <input type="file" class="form-control" name="pas_photo"
                            id="pas_photo" onchange="previewImage()" required>
